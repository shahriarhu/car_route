...
class DropdownButtonWidget<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        TitleMedium(text: '${label.tr}:', color: secondaryColor),
        ...
        Container(
          ...
          child: DropdownButton<T>(
            ...
            isExpanded: true,
            onChanged: onChanged,
            hint: BodyLarge(text: 'selectLabel'.trParams({'label': label.tr.toLowerCase()})),
            icon: const Icon(Icons.expand_more, color: secondaryColor),
